...
parser::node parser::node_generator::generate(const std::string& text)
{
    auto extended_text = extend_label(extend_range(extend_or(extend_star(text, 0), 0), 0), 0);
...
std::string parser::node_generator::extend_star(const std::string& text, const int num)
{
    bool escaped = false;
    int found = 0;
    int brackets = 0;
...
std::string parser::node_generator::extend_or(const std::string& text, const int num)
{
    bool escaped = false;
    int found = 0;
    int brackets = 0;
...
std::string parser::node_generator::extend_range(const std::string& text, const int num)
{
    bool escaped = false;
    int found = 0;
    int brackets = 0;
...
std::string parser::node_generator::extend_label(const std::string& text, const int num)
{
    bool escaped = false;
    int found = 0;
...
void parser::node_generator::reduce_node(parser::node& n)
{
...
void parser::node_generator::split_node(parser::node& n)
{
    split_block_node(n);
...
void parser::node_generator::split_block_node(parser::node& n)
{
